    ...
    <tr key={purchaseOrder.id}>
      ...
      <td className="text-left px-2 py-3 whitespace-nowrap">
        <span className="text-sm text-gray-500 flex gap-1">{purchaseOrder.status}
          {purchaseOrder.totalQuantity > 0 ? <svg onClick={openChangeStatusModal} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-5 hover:fill-[#60a5fa] cursor-pointer">
      ...
      <td className="text-left px-2 py-3 whitespace-nowrap">
        <span className="text-sm text-gray-500 flex gap-1">
          <Link
            ...
            href={{ pathname: '/stores', query: { store: purchaseOrder.store?.name } }}
          >
      ...
      <td className="text-right px-2 py-3 whitespace-nowrap flex gap-2 align-center">
