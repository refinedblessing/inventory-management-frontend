...
const Category = ({ category, deleteCategory, editCategory }: any) => {
  return (
    <tr key={category.id}>
      ...
      <td className="text-right px-0 py-3 whitespace-nowrap flex gap-2">
        ...
        <svg onClick={() => deleteCategory(category.id)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 hover:fill-[#e11d48] cursor-pointer">
